...
Now if were were to consider a real data set, it would have ***X*** genes and ***Y*** cells, then this plot would have ***X*** dimensions and ***Y*** points.
...
::: callout-tip
# [**Exercise 3**](05_theory_of_PCA_Answer-key.qmd#exercise-3)
