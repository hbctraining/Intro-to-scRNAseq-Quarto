...
::: callout-tip
# [Exercises](sc_exercises_qc_analysis.qmd)
...
::: callout-note
The data we are working with is pretty good quality. If you are interested in knowing what 'bad' data might look like when performing QC, we have some materials [linked here](QC_bad_data.qmd) where we explore similar QC metrics of a poor quality sample._
:::